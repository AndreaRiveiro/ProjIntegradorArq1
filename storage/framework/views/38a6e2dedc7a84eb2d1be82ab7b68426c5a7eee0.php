...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="<?php echo e(asset('css/produto.css')); ?>">
    <link rel="stylesheet" type="text/css" media="screen" href="<?php echo e(asset('css/pageProdutos.css')); ?>">
                    ...
                    <div id="containerLogado">
                        <p id="primNome">
                            <a class="btn btn-primary btn-outline-info" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                               Olá, <?php echo e(auth()->user()->prim_nome); ?>
...
</html><?php /**PATH C:\Users\tomeshi\Documents\Andrea\PFS2\ProjetoIntegrador\Camila\ProjIntegradorArq1\ProjIntegradorArq1\MeSustenta\resources\views/template.blade.php ENDPATH**/ ?>
...
<div class="card cadastro-content col-md-8">
    ...
    <form id="form-cadastro" method="POST" action="/cadastroAdmin">
    @csrf
        ...
        <div class="form-group" >
            ...
            <div class="btn12">
                <button id="bt_submit" type="submit" name='cadastroAdmin' class="btn btn-success btn-casds">Enviar</button>

...
<section class="container sobre-conteudo col-12 col-sm-12 col-md-11 col-lg-11 col-xl-10">
        ...
        <video controls poster="" class="col-12 col-sm-10 col-md-12 col-lg-12 col-xl-10 videomd">
                <source src="<?php echo e(asset('video/3Rs.mp4')); ?>" type="video/mp4">
            </video>
            <div class="row">
                <div class="card mb-3">
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Documentos\Digital House\ProjIntegradorArq1\MeSustenta\resources\views/sobre.blade.php ENDPATH**/ ?>